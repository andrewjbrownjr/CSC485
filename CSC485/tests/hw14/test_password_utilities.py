import pytest
from CSC485.projects.hw14 import password_utilities
...
class TestComputeComplexity:
    ...
    def test_all_complexifiers(self, key):
        ...
        '''
        assert password_utilities.compute_complexity(key) == 100
    ...
    def test_half_complexifiers(self, key):
        ...
        '''
        assert password_utilities.compute_complexity(key) == 50
    ...
    def test_quarter_complexifiers(self, key):
        ...
        '''
        assert password_utilities.compute_complexity(key) == 25
    ...
    def test_tenth_complexifiers(self, key):
        ...
        '''
        assert password_utilities.compute_complexity(key) == 10
    ...
    def test_no_complexifiers(self, key):
        ...
        '''
        assert password_utilities.compute_complexity(key) == 0
    ...
    def test_51_percent(self):
        ...
        assert password_utilities.compute_complexity(key) == 51
    ...
    def test_49_percent(self):
        ...
        assert password_utilities.compute_complexity(key) == 49
    ...
    def test_not_a_string(self, key):
        ...
        with pytest.raises(TypeError):
            password_utilities.compute_complexity(key)
...
class TestEvaluateStrength:
    ...
    '''
    @pytest.mark.parametrize('strong_password', ['##', '$ee%', '___a', 'p@@@@p','o--oo-_-'])
    def test_strong_password(self, strong_password):
        ...
        '''
        assert password_utilities.evaluate_strength(strong_password)

    @pytest.mark.parametrize('weak_password', ['abcd', 'password', 'pass##', '123$'])
    def test_weak_password(self, weak_password):
        ...
        '''
        assert not password_utilities.evaluate_strength(weak_password)
